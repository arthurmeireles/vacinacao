(function ($) {
  ...
  DayScheduleSelector.DEFAULTS = {
    ...
    interval    : 30,                     // minutes
    stringDays  : ['Segunda-feira', 'Terça-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-Feira', 'Sábado', 'Domingo'],
  ...
  DayScheduleSelector.prototype.attachEvents = function () {
    ...
    this.$el.on('click', '.time-slot', function () {
      ...
      var attr2 = $(this).attr("desabilitado");
      if ((attr1!="disabled" || attr2!="disabled") && !($(this).hasClass("selecionar_hora"))){
